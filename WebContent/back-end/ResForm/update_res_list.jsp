			...
			<table>
				...
				<c:forEach var="resformVO" items="${list}" begin="0">
					...
					<tr>
						...
						<td>
							<FORM METHOD="get" ACTION="resform.do"
										style="margin-bottom: 0px;">
										<input type="hidden" value="${resformVO.res_Num}"> <input class="hover2" type="image" id="${resformVO.res_Num}"
											name="submit" src="image/pen.png" alt="Submit" width="30px" height="30px" /> 
											<input type="hidden" name="res_Num" value="${resformVO.res_Num}"> 
