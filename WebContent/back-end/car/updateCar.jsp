...
<link type="text/css" rel="stylesheet" href="<%= request.getContextPath()%>/back-end/car/css/updateCar.css">
...
<body>
	...
	<jsp:useBean id="student" scope="page" class="com.student.model.StudentService"/>
		...
		<%--修改資料 燈箱 --%>
		<div id="hidden_update">
			<div class="addCar">
		    	<form action="<%=request.getContextPath()%>/car/car.do" method="post">
		    		<h3 class="addCar">修改幼童車資料</h3>
		    		
		    		<b class="addCar">幼童車編號：</b><b>${carVO.car_num}</b><input type="hidden" name="car_num" value="${carVO.car_num}"><br>
