...
<div id="left" class="col-lg-2 col-md-2 cb div-gradient">
            ...
            <br>
            <div class="meiSin"><span class="blue">美</span><span class="lightblue">心</span><span class="pink">幼</span><span class="gold">兒</span><span class="red">園</span> <span class="lightgreen">管</span><span class="gold">理</span><span class="pink">平</span><span class="lightblue">台</span></div>

            <button class="collapsible">幼兒資訊</button>
            <div class="content">
              <button class="btn">管理幼兒資料</button><br>
              <button class="btn">管理幼童車</button><br>
              <button class="btn">管理繳費單</button><br>
            </div>
            ...
            <!-- <button class="css_button"></button> -->
