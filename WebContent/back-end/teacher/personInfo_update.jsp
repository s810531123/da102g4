...
<head>
	...
	<title>教職員資料修改 - personInfo_update.jsp</title>
...
<body>
	...
	<div class="col-lg-10 col-md-10 cb rightContent">
		<div class="own">
			...
			<h3><a href="<%= request.getContextPath()%>/back-end/teacher/listAllTeacher.jsp"><img src="<%= request.getContextPath()%>/back-end/teacher/images/back.jpg" width="40" height="40" border="0" id="back" title="返回"></a>資料修改</h3>
			...
			<FORM METHOD="post" ACTION="<%= request.getContextPath()%>/teacher/teacher.do" name="form1" enctype="multipart/form-data">
				<table id="table-1">
					<tr class="updateOne">
						<td class="updateTitle">相片:<font color=red></font></td>
						<td>
							<input type="file" name="t_photo" onchange="openFile(event)"><br>
				...
				<br>
				<input type="hidden" name="action" value="startupdateSelf">
