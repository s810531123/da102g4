...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/front-end/css/lightBox.css" />
...
<script>
	$(document).ready(function(){
		...
		$("#btn1").click(function() {
		    $("#password").attr("value","000000");
		    $("#account").attr("value","S001");
		});
		$("#btn2").click(function() {
			 $("#password").attr("value","000001");
			    $("#account").attr("value","S002");
		});
		$("#btn3").click(function() {
			 $("#password").attr("value","000002");
			    $("#account").attr("value","S003");
		});
	});
			...
			<div class="content">
				...
				<FORM METHOD="post"
					...
					<table>
						<tr>
							<th>帳號:</th>
							<td><input type='text' name='account' id="account" required
						...
						<tr>
							<th>密碼:</th>
							<td><input type='password' value="" name='password' id="password" required /></td>
						</tr>
						<tr>
							<td colspan='2'>
						...
						<tr>
							<td>
							<input style="width:100px;height:70px;opacity: 0;cursor: pointer;" type="button" name="btn1" id="btn1">										
							</td>
							<td>
							<input style="width:210px;height:70px;opacity: 0;cursor: pointer;" type="button" name="btn2" id="btn2">									
							</td>
							<td>
							<input style="width:100px;height:70px;opacity: 0;cursor: pointer;" type="button" name="btn3" id="btn3">									
							</td>
						</tr>						
					</table>
				</FORM>
