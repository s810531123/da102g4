...
<body>
    ...
    <!-- 信用卡 -->
<img src="<%=request.getContextPath()%>/front-end/images/icon.png" style="height:300px;width:500px;">
    ...
    <div>
    	<form action="<%=request.getContextPath()%>/courselistPay/courselistPay.do" METHOD="post">
    		<input type="hidden" value="${st_num}" name="st_num">
    		<input type="hidden" value="${cou_num}" name="cou_num">
    		<input type="hidden" value="paypay" name="action">
