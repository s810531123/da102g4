...
public class Class_annServlet_front extends HttpServlet{
		...
		if("getOne_For_Display".equals(action)) {
			...
			try {
				...
				if(!errorMsgs.isEmpty()) {
					RequestDispatcher failureView = req.getRequestDispatcher("/front-end/class_ann/search_page.jsp");
					failureView.forward(req, res);
					return;
				}
				/****************3.查詢完成後轉交***********************************/
				req.setAttribute("class_annVO", class_annVO);
				String url = "/front-end/class_ann/search_page.jsp";
